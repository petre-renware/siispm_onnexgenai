...
* *zonele, rutele* ce raspund la serviciile respective precum si regulile aferente de (web) networking sunt implementate folosind [Componenta Server Web](https://nexgenai.app/v2.3.3/comp_server_web.html)
...
* partea de *controller a rutelor* este realizata cu oricare din serverele de aplicatie din [Componenta Server de Aplicatii](https://nexgenai.app/v2.3.3/comp_server_app.html)
